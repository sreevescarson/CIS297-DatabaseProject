...
namespace CollegeRegistration {
    ...
    public partial class CourseDataSet : global::System.Data.DataSet {
        ...
        public partial class CourseDataTable : global::System.Data.TypedTableBase<CourseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CourseRow AddCourseRow(string Name, int Number, int Credits, string Department) {
...
namespace CollegeRegistration.CourseDataSetTableAdapters {
    ...
    public partial class CourseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Course] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_N" +
                "ame) AND ([Number] = @Original_Number) AND ([Credits] = @Original_Credits) AND (" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Course] ([Name], [Number], [Credits], [Department]) VALUES (@N" +
                "ame, @Number, @Credits, @Department);\r\nSELECT Id, Name, Number, Credits, Departm" +
                "ent FROM Course WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Course] SET [Name] = @Name, [Number] = @Number, [Credits] = @Credits, [Department] = @Department WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Number] = @Original_Number) AND ([Credits] = @Original_Credits) AND ([Department] = @Original_Department));
SELECT Id, Name, Number, Credits, Department FROM Course WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Number, Credits, Department FROM dbo.Course";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, int Original_Number, int Original_Credits, string Original_Department) {
        ...
        public virtual int Insert(string Name, int Number, int Credits, string Department) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, int Number, int Credits, string Department, int Original_Id, string Original_Name, int Original_Number, int Original_Credits, string Original_Department, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Number, int Credits, string Department, int Original_Id, string Original_Name, int Original_Number, int Original_Credits, string Original_Department) {
            return this.Update(Name, Number, Credits, Department, Original_Id, Original_Name, Original_Number, Original_Credits, Original_Department, Original_Id);
        }
    }
