...
namespace CollegeRegistration {
    ...
    public partial class StudentDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StudentsRow AddStudentsRow(string Name, int MajorID) {
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public int MajorID {
                get {
                    return ((int)(this[this.tableStudents.MajorIDColumn]));
                }
                set {
                    this[this.tableStudents.MajorIDColumn] = value;
                }
            }
        }
...
namespace CollegeRegistration.StudentDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([Id] = @Original_Id) AND ([Name] = @Original" +
                "_Name) AND ([MajorID] = @Original_MajorID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([Name], [MajorID]) VALUES (@Name, @MajorID);\r\nSELEC" +
                "T Id, Name, MajorID FROM Students WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Students] SET [Name] = @Name, [MajorID] = @MajorID WHERE (([Id] = @" +
                "Original_Id) AND ([Name] = @Original_Name) AND ([MajorID] = @Original_MajorID));" +
                "\r\nSELECT Id, Name, MajorID FROM Students WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, MajorID FROM dbo.Students";
